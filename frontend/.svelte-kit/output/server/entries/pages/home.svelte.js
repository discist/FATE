import { c as create_ssr_component } from "../../chunks/index-1ba8bc78.js";
...
const Home = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  $$result.css.add(css);
  return `<main class="${"flex flex-col font-mono items-center justify-center mt-56"}">EAT ASS


    <div class="${"stars -z-10 svelte-17yssfa"}"></div>
    <div class="${"twinkling -z-10  svelte-17yssfa"}"></div>
    <div class="${"clouds svelte-17yssfa"}"></div>
