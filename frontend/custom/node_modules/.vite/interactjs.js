      ...
      var on = function() {
        ...
        return e2 = t2, (n2 = [{ key: "start", value: function(t3) {
          ...
          if (l2 < this.te) {
            ...
            this.isModified ? (0, 0, t3 = this.targetOffset.x, e3 = this.targetOffset.y, n3 = this.modifiedOffset.x, r2 = this.modifiedOffset.y, u2 = { x: sn(o2 = c2, 0, t3, n3), y: sn(o2, 0, e3, r2) }) : u2 = { x: this.targetOffset.x * c2, y: this.targetOffset.y * c2 };
...
// dep:interactjs
var interactjs_default = require_interact_min();
export {
  interactjs_default as default
};
