...
export { _api, addAPIProvider, addCollection, addIcon, buildIcon, calculateSize, checkIconState, disableCache, enableCache, generateIcon, getIcon, iconExists, listIcons, loadIcon, loadIcons, replaceIDs, shareStorage };
